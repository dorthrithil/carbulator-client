...
import {delay, map, mergeMap, repeatWhen, startWith, takeWhile} from 'rxjs/operators';
...
export class MinutesRemainingPipe implements PipeTransform, OnDestroy {
  ...
  /**
   * Get's a timer observable that emits every full minute and one time immediately.
